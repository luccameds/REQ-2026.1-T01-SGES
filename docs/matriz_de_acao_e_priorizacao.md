...
- **Peso Legal (Risco Extremo - Notas 4 a 5):** Requisitos inegociáveis para a sobrevivência e adequação da instituição. Lidar com famílias vulneráveis exige rigor com a LGPD. (Exemplo: _RNF01 - Criptografia Sensível_ e _RF08 - Cadastrar família_ recebem nota 5).
- **Peso da Missão (Impacto Social - Notas 4 a 5):** Funcionalidades que resolvem o problema motivador do software: o combate à evasão. (Exemplo: _RF18 - Emitir alerta de evasão_ recebe nota 5, pois atua diretamente na retenção do beneficiário).
- **Peso de Conforto Operacional (Nice-to-have - Notas 1 a 3):** Funcionalidades secundárias que geram conforto ou caminhos alternativos de gestão, mas não salvam vidas ou previnem processos legais. (Exemplo: _RF24 - Exportar matriz em PDF_ recebe nota 3, pois a gestão já possui acesso aos dados em tela).
...
- **Nível 3 (Lógica Relacional Moderada):** Requisitos que exigem cruzamento de múltiplas tabelas e validações de regras de negócio antes da persistência de dados. (Exemplo: _RF14 - Matricular beneficiário_, que exige validação de vagas, choque de horários e status ativo).
- **Nível 4 e 5 (Processamento Assíncrono / Arquitetura Complexa):** Funcionalidades que fogem do fluxo linear de tela, exigindo _background jobs_, operações _offline-first_ ou varreduras massivas no banco de dados. (Exemplo: _RF18 - Emitir alerta de evasão_ recebe nota 4, pois exige que o servidor processe o histórico de todos os alunos diariamente buscando padrões temporais complexos).
...
| **RF07** | Registrar termo de consentimento    |      5      |         3          | **2º Quadrante**  |
| **RF08** | Cadastrar família assistida         |      5      |         2          | **1º Quadrante**  |
| **RF09** | Editar dados da família             |      4      |         2          | **1º Quadrante**  |
| **RF10** | Inativar cadastro familiar          |      4      |         2          | **1º Quadrante**  |
| **RF11** | Cadastrar beneficiário              |      5      |         2          | **1º Quadrante**  |
| **RF12** | Editar dados do beneficiário        |      3      |         2          | **3º Quadrante**  |
| **RF13** | Cadastrar oficina/atividade         |      4      |         2          | **1º Quadrante**  |
| **RF14** | Matricular beneficiário             |      4      |         3          | **2º Quadrante**  |
| **RF15** | Registrar presença em lote          |      5      |         2          | **1º Quadrante**  |
| **RF16** | Alterar registro de frequência      |      4      |         3          | **2º Quadrante**  |
| **RF17** | Registrar falta justificada         |      4      |         2          | **1º Quadrante**  |
| **RF18** | Emitir alerta de evasão             |      5      |         4          | **2º Quadrante**  |
| **RF19** | Consultar histórico do beneficiário |      4      |         3          | **2º Quadrante**  |
| **RF20** | Registrar intervenção social        |      5      |         2          | **1º Quadrante**  |
| **RF21** | Encerrar alerta de evasão           |      4      |         3          | **2º Quadrante**  |
