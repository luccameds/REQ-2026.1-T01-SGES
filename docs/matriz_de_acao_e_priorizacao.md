...
- **Peso da Missão (Impacto Social - Notas 4 a 5):** Funcionalidades que resolvem o problema motivador do software: o combate à evasão. (Exemplo: _RF14 - Emitir alerta de evasão_ recebe nota 5, pois atua diretamente na retenção do beneficiário).
...
- **Nível 3 (Lógica Relacional Moderada):** Requisitos que exigem cruzamento de múltiplas tabelas e validações de regras de negócio antes da persistência de dados. (Exemplo: _RF10 - Matricular beneficiário_, que exige validação de vagas, choque de horários e status ativo).
- **Nível 4 e 5 (Processamento Assíncrono / Arquitetura Complexa):** Funcionalidades que fogem do fluxo linear de tela, exigindo _background jobs_, operações _offline-first_ ou varreduras massivas no banco de dados. (Exemplo: _RF14 - Emitir alerta de evasão_ recebe nota 4, pois exige que o servidor processe o histórico de todos os alunos diariamente buscando padrões temporais complexos).
...
| **RF07** | Cadastrar beneficiário              |      5      |         2          | **1º Quadrante**  |
| **RF08** | Editar dados do beneficiário        |      3      |         2          | **3º Quadrante**  |
| **RF09** | Cadastrar Turma                     |      4      |         2          | **1º Quadrante**  |
| **RF10** | Matricular beneficiário             |      4      |         3          | **2º Quadrante**  |
| **RF11** | Registrar presença em lote          |      5      |         2          | **1º Quadrante**  |
| **RF12** | Alterar registro de frequência      |      4      |         3          | **2º Quadrante**  |
| **RF13** | Registrar falta justificada         |      4      |         2          | **1º Quadrante**  |
| **RF14** | Emitir alerta de evasão             |      5      |         4          | **2º Quadrante**  |
| **RF15** | Consultar histórico do beneficiário |      4      |         3          | **2º Quadrante**  |
| **RF16** | Gerar relatório de frequência       |      4      |         3          | **2º Quadrante**  |
