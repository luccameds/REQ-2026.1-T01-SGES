...
| **RN01-02** $\text{implícita}$ | Bloqueio por Tentativas Consecutivas      | Após **5 tentativas falhas consecutivas** de login, a conta do usuário é automaticamente bloqueada e o evento é registrado na trilha de auditoria.                                            | CSU01 FE-4-C (RF01 CA01-02)         | Segurança  |
| **RN01-03** $\text{implícita}$ | Bloqueio de Contas Inativas               | Contas com status inativo ou sem perfil de permissão válido são impedidas de autenticar no sistema.                                                                                           | CSU01 FE-4-E (RF01 CA01-04)         | Segurança  |
...
| **RN03-01** $\text{implícita}$ | Expiração por Inatividade                 | A sessão do usuário é invalidada automaticamente após **15 minutos consecutivos de inatividade**, exigindo novo login.                                                                        | CSU03 FA-1-A (RF03 CA03-02 / RNF06) | Segurança  |
...
| **RN16-01**                    | Revogação de Acessos na Inativação    | A inativação lógica (_soft delete_) de um instrutor acarreta a invalidação imediata de **todas** as suas sessões ativas e impede novas autenticações.          | CSU16 (RF06)         | Segurança   |
| **RN16-02** $\text{implícita}$ | Integridade Referencial na Inativação | A inativação do instrutor é feita por _soft delete_ (exclusão lógica), preservando o histórico de turmas e registros associados ao instrutor na base de dados. | CSU16 (RF06 CA06-01) | Integridade |
...
| **RN06-02** $\text{implícita}$ | Unicidade de CPF e E-mail do Beneficiário    | O CPF (se fornecido) e o e-mail do beneficiário devem ser únicos na base de dados, impedindo duplicidades.          | CSU06 (RF07 CA07-03) | Integridade |
...
| **RN08-04** $\text{implícita}$ | Prevenção de Duplicidade de Turma                 | O sistema bloqueia a criação de uma turma com o **mesmo nome, horários, dias da semana e semestre letivo** de uma turma já ativa, evitando duplicidade.                     | CSU08 FE-4-E (RF09 CA09-04) | Integridade |
...
| **RN11-02** $\text{implícita}$ | Restrições de Upload de Comprovante               | O upload de comprovante de falta justificada é limitado a arquivos de **até 5 MB** nos formatos **PDF, JPG ou PNG**.                                                        | CSU11 FE-4-A (RF13 CA13-02) | Validação   |
...
| **RN15-02** $\text{implícita}$ | Mascaramento de Dados em Exportação CSV | Dados de identificação pessoal (CPF, contatos) devem ser **ofuscados/mascarados** nos relatórios CSV exportados (ex: `***.123.***-##` para CPF), em conformidade com a LGPD.      | CSU15 (RF16 CA16-01 / RNF03) | Segurança    |
...
| :------------------------- | :------------------------------------------ | :------------------ | :-- |
| RN01-01                    | CSU01 — Autenticar usuário                  | RF01                | CP1 |
| RN01-02 $\text{implícita}$ | CSU01 — Autenticar usuário                  | RF01                | CP1 |
| RN01-03 $\text{implícita}$ | CSU01 — Autenticar usuário                  | RF01                | CP1 |
| RN02-01                    | CSU02 — Redefinir senha de acesso           | RF02                | CP1 |
| RN02-02                    | CSU02 — Redefinir senha de acesso           | RF02                | CP1 |
| RN02-03                    | CSU02 — Redefinir senha de acesso           | RF02                | CP1 |
| RN02-04                    | CSU02 — Redefinir senha de acesso           | RF02                | CP1 |
| RN03-01 $\text{implícita}$ | CSU03 — Encerrar sessão                     | RF03                | CP1 |
| RN04-01                    | CSU04 — Cadastrar instrutor                 | RF04                | CP2 |
| RN04-02                    | CSU04 — Cadastrar instrutor                 | RF04                | CP2 |
| RN05-01                    | CSU05 — Editar perfil do instrutor          | RF05                | CP2 |
| RN05-02                    | CSU05 — Editar perfil do instrutor          | RF05                | CP2 |
| RN06-01                    | CSU06 — Cadastrar beneficiário              | RF07                | CP3 |
| RN06-02 $\text{implícita}$ | CSU06 — Cadastrar beneficiário              | RF07                | CP3 |
| RN07-01                    | CSU07 — Editar dados do beneficiário        | RF08                | CP3 |
| RN08-01                    | CSU08 — Cadastrar turma                     | RF09                | CP4 |
| RN08-02                    | CSU08 — Cadastrar turma                     | RF09                | CP4 |
| RN08-03                    | CSU08 — Cadastrar turma                     | RF09                | CP4 |
| RN08-04 $\text{implícita}$ | CSU08 — Cadastrar turma                     | RF09                | CP4 |
| RN09-01                    | CSU09 — Matricular beneficiário             | RF10                | CP4 |
| RN09-02                    | CSU09 — Matricular beneficiário             | RF10                | CP4 |
| RN09-03                    | CSU09 — Matricular beneficiário             | RF10                | CP4 |
| RN10-01                    | CSU10 — Alterar registro de frequência      | RF12                | CP4 |
| RN10-02                    | CSU10 — Alterar registro de frequência      | RF12                | CP4 |
| RN11-01                    | CSU11 — Registrar falta justificada         | RF13                | CP4 |
| RN11-02 $\text{implícita}$ | CSU11 — Registrar falta justificada         | RF13                | CP4 |
| RN12-01                    | CSU12 — Registrar presença em lote          | RF11                | CP4 |
| RN12-02                    | CSU12 — Registrar presença em lote          | RF11                | CP4 |
| RN12-03                    | CSU12 — Registrar presença em lote          | RF11                | CP4 |
| RN13-01                    | CSU13 — Emitir alerta de evasão             | RF14                | CP5 |
| RN13-02                    | CSU13 — Emitir alerta de evasão             | RF14                | CP5 |
| RN14-01                    | CSU14 — Consultar histórico do beneficiário | RF15                | CP5 |
| RN15-01                    | CSU15 — Gerar relatório de frequência       | RF16                | CP6 |
| RN15-02 $\text{implícita}$ | CSU15 — Gerar relatório de frequência       | RF16                | CP6 |
| RN16-01                    | CSU16 — Inativar instrutor                  | RF06                | CP2 |
| RN16-02 $\text{implícita}$ | CSU16 — Inativar instrutor                  | RF06                | CP2 |
...
3. **Resolver a divergência RN02-02:** Alinhar o tempo de expiração do token de redefinição de senha entre o RF02 e o CSU02.
