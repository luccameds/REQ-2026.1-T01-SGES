# SGES
## Checklist de DoR e DoD: CSU13 (RF14) - Emitir alerta de evasão
...
![Protótipo - CSU13](CSU13.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem;"}
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU13` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #69 (feat: matriculas)
    * **Commits principais:** `8b19673`
