# SGES
## Checklist de DoR e DoD: CSU08 (RF09) - Cadastrar Turma
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU08` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #69 (feat: matriculas)
    * **Commits principais:** `7d80394`, `22d3748`
...
- [x] Foram implementados testes unitários para cobrir as regras de negócio deste caso de uso?
    * **Comando para execução dos testes:**
      ...
      npx vitest run src/shared/api/classes.spec.ts
      ```
