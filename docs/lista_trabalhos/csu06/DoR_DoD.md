# SGES
## Checklist de DoR e DoD: CSU06 (RF07) - Cadastrar beneficiário
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU06` no sistema de controle de versão (ex: nos commits/PRs)?
