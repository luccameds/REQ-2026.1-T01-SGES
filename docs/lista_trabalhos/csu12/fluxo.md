...
4. O Instrutor clica em 'Salvar Presenças'.
5. O sistema valida se a data da chamada corresponde à data atual do servidor.
6. O sistema grava em lote as presenças e faltas da turma e exibe mensagem de sucesso.

---

### 3. Fluxos Alternativos
#### FA1 - Registro em Modo Offline
