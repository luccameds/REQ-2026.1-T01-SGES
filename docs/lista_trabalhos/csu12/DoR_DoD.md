...
![Protótipo - CSU12](../../images/DoR/CSU12.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem;"}
...
- [ ] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU12` no sistema de controle de versão (ex: nos commits/PRs)?
