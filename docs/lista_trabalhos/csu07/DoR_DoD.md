# SGES
## Checklist de DoR e DoD: CSU07 (RF08) - Editar dados do beneficiário
...
![Protótipo - CSU07 - Tela 1](../../images/DoR/CSU07-1.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem; margin-bottom: 1rem;"}

![Protótipo - CSU07 - Tela 2](../../images/DoR/CSU07-2.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem;"}
...
- [ ] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU07` no sistema de controle de versão (ex: nos commits/PRs)?
