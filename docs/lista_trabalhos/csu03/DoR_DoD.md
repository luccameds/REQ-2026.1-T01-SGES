...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU03` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #32 (feat: implementa fluxo de autenticação e dashboard base (FSD))
    * **Commits principais:** `43796d5`, `182d96e`
...
- [x] Foram implementados testes unitários para cobrir as regras de negócio deste caso de uso?
    * **Comando para execução dos testes:**
      ...
      ./run-tests.sh test/unit/auth-middleware.spec.ts
      ```
