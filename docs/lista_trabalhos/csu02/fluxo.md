...
4. O sistema valida se o e-mail informado pertence a uma conta ativa.
...
7. O usuário acessa o link seguro através do e-mail recebido e é direcionado para a tela de criação de nova senha.
...
#### FE2 - Link/Token Expirado ou Inválido
