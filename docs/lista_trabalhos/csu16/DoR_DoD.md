# SGES
## Checklist de DoR e DoD: CSU16 (RF06) - Inativar instrutor
...
![Protótipo - CSU16](CSU16.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem;"}
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU16` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #51 (feat(frontend): adicionar gerenciamento e cadastro de instrutores)
    * **Commits principais:** `62472bb`, `b9ed321`
