...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU15` no sistema de controle de versão (ex: nos commits/PRs)?
...
- [x] Foram implementados testes unitários para cobrir as regras de negócio deste caso de uso?
    * **Comando para execução dos testes:**
      ...
      ./run-tests.sh test/unit/get-frequency-report-usecase.spec.ts
      ```
