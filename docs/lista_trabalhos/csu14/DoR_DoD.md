# SGES
## Checklist de DoR e DoD: CSU14 (RF15) - Consultar histórico do beneficiário
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU14` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #71 (docs: atualizar andamento dos casos de uso para concluído)
    * **Commits principais:** `43bd132`, `f582c5d`
...
- [x] Foram implementados testes unitários para cobrir as regras de negócio deste caso de uso?
    * **Comando para execução dos testes:**
      ...
      ./run-tests.sh test/unit/get-student-history-usecase.spec.ts
      ```
