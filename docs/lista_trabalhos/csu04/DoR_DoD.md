# SGES
## Checklist de DoR e DoD: CSU04 (RF04) - Cadastrar instrutor
...
![Protótipo - CSU04](CSU04.png){: style="border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-width: 100%; border: 1px solid var(--sges-card-border); margin-top: 1rem;"}
...
- [x] A entrega está devidamente rastreada e referenciada ao caso de uso `CSU04` no sistema de controle de versão (ex: nos commits/PRs)?
    * **Pull Request:** #51 (feat(frontend): adicionar gerenciamento e cadastro de instrutores)
    * **Commits principais:** `b9ed321`, `232c72e`, `a08f657`, `62472bb`
...
- [x] Foram implementados testes unitários para cobrir as regras de negócio deste caso de uso?
    * **Comando para execução dos testes:**
      ...
      ./run-tests.sh test/unit/create-user-usecase.spec.ts
