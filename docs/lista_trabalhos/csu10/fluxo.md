...
### Fluxo principal:
1. O Gestor acessa o diário de classe de uma turma e seleciona uma aula passada para edição. (FA-1-A; FE-1-A; FE-1-B)
...
6. O sistema persiste a alteração de frequência e a justificativa para auditoria no banco de dados. (RNF02; FE-6-A; FE-6-B; FE-6-C)
